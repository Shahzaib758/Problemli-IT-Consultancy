...
<body>
   ...
   <main>
      <div class="portfolio-section">
         <div class="container portfolio-section-header">
            <h1>Portfolio</h1>
            <div class="row">
               <div class="col-md-8">
                  <p>Explore Our Portfolio of Innovation and Imagination</p>
               </div>
               <div class="col-md-4 d-flex">
                  <input type="text" class="input-feilds">
                  <input type="submit" value="filter" class="input-submit btn">
               </div>
            </div>
         </div>

         <div class="container portfolio-section-body">
            <div class="d-flex flex-wrap">
               <div class="wow animate__zoomIn" data-wow-delay=".4s">
                  <a href="./portfolio-1.php">
                     ...
                     <div class="content">
                        ...
                        <p class="context">Software support for lightning-fast tyre changes</p>
